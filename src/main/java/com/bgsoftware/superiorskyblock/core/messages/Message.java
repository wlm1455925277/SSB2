...
public enum Message {
    ...
    BANK_DEPOSIT_CUSTOM,
    BANK_INTEREST_STATUS_BANK_LIMIT_REACHED,
    BANK_INTEREST_STATUS_DISABLED,
    BANK_INTEREST_STATUS_READY,
    BANK_INTEREST_STATUS_WAITING,
    BANK_INTEREST_STATUS_WAITING_OWNER_ACTIVE,
    BANK_LIMIT_EXCEED,
